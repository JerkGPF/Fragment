...
public class MyCountTimer extends CountDownTimer {
    ...
    public static String endStrRid;
     ...
     */
    public MyCountTimer(long millisInFuture, long countDownInterval, TextView btn, String endStrRid,Context context ) {
